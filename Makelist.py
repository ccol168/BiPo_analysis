...
def crea_liste_per_run(cartella_finale):
    """Crea file di lista per RUN, processando sia 'ds-2' che 'ds-3'."""
    
    #percorso_base = "/junofs/production/commissioning/esd/J25.1.5/2025/"
    percorso_base = "/junofs/production/commissioning/esd/J25.2.2/2025/"
    cartella_completa = os.path.join(percorso_base, cartella_finale)

    percorso_rtraw = "/junofs/production/commissioning/rtraw/2025/"
...
def main():
    ...
    crea_liste_per_run(args.cartella_finale)

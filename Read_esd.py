...
def make_sh (infile, RunID, corrList) :
    ...
    thispath = "/junofs/users/gferrante/BiPo/"
    ...
    #    file.write("export LC_ALL=C \n")
        file.write("source /cvmfs/juno.ihep.ac.cn/el9_amd64_gcc11/Release/J25.1.6/setup.sh \n")
        ...
        if (corrList == None) :
            file.write("python /junofs/users/gferrante/BiPo/Run_analyzer/Export_run.py -input-list " + infile + " -output " + outfile + "  >& " + thispath + "log/" + RunID + "_python.log")
        else:
            file.write("python /junofs/users/gferrante/BiPo/Run_analyzer/Export_run.py -input-list " + infile + " -output " + outfile + " -corr-list " + corrList +"  >& " + thispath + "log/" + RunID + "_python.log")
